...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", 
    ...
    "app_generators/sample/sample_generator.rb",
    "bin/sample",
    "app_generators/sample/templates/Gemfile",
    "app_generators/sample/templates/Gemfile.lock",
    "app_generators/sample/templates/Procfile",
    "app_generators/sample/templates/Rakefile",
    "app_generators/sample/templates/application.rb",
    "app_generators/sample/templates/database.yml",
    "app_generators/sample/templates/server.rb ",
    ".gemtest"]
